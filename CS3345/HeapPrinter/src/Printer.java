...
public class Printer {
    ...
    public static void main(String[] args) {
        BinaryHeap<Printjob> printHeap = new BinaryHeap<>();
        ...
        try {
            ...
            while (scn.hasNextLine()) {
                ...
                if (st.nextToken().equals("I"))
                    printHeap.insert(new Printjob(name, priority, numPages));
                else
                    printHeap.insert(new OutsidePrintjob(name, priority, numPages));
            }
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }

        while (!printHeap.isEmpty()) {
            try {
                System.out.println(printHeap.deleteMin());
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
