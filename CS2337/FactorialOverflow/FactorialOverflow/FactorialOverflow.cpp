...
Matthew Hui
Oct 7 2022
This program calculates factorial overflow with different numerical types, both iteratively and recursively.
*/
...
void factorialRecursiveFunc(TypeMultiply& multiplier, TypeMultiply factorialResult) {
    ...
    if (isSafeMultiply <TypeMultiply> (multiplier, factorialResult, factorialResult)) {
        cout << setw(3) << multiplier << setw(27) << factorialResult << endl;
